...
%pathSonarQubeExe% begin /k:"com.company.blogengine" /n:"BlogEngine" /v:"1.0.0" /d:sonar.host.url="http://67.207.94.110:9000" /d:sonar.login="admin" /d:sonar.password="admin" 
